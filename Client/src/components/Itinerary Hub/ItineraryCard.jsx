              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-end pt-4 border-t border-gray-100 space-x-3">
                    <button
                      className="flex items-center space-x-1 text-sm px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors duration-200 group-hover:border-red-300 group-hover:text-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                    ...
                    <button
                      className="flex items-center space-x-1 text-sm px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
