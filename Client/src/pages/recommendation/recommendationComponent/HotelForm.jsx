...
const HotelForm = ({ onSubmit, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await hotelAPI.saveHotel(hotelData);
      ...
      const errorMessage = error.response?.data?.message || error.message || 'An error occurred while saving the hotel.';
